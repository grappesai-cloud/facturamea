...
export default function FiscalSettings() {
  ...
  return (
    <div className="max-w-2xl space-y-4">
        ...
        <CardContent className="p-5 space-y-4">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-[#A8BED2]">Emite bon fiscal real prin driverul local. Setări per dispozitiv.</p>
              </div>
            </div>
            <button
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <Label className="text-xs text-[#A8BED2]">Aparat detectat</Label>
          ...
          <div>
            <Label className="mb-1 block text-xs text-[#A8BED2]">Mapare cote TVA → grupa de taxă pe aparat</Label>
            <p className="text-[11px] text-[#8FA6BC] mb-2">Depinde de fiscalizarea aparatului. Implicit RO: A=standard, B=redusă, C=5%, D=0%.</p>
            <div className="grid grid-cols-5 gap-2">
              {VAT_RATES.map((rate) => (
                <div key={rate}>
                  <Label className="mb-1 block text-[11px] text-[#A8BED2] text-center">{rate}%</Label>
                  <Input
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            <Button className="rounded-full bg-[#E1FB15] text-[#07090f] font-bold hover:bg-[#D2EA0E]" onClick={save}>
      ...
      <p className="text-xs text-[#8FA6BC] leading-relaxed">
        Driverul <a href="https://github.com/erpnet/ErpNet.FP" target="_blank" rel="noopener" className="text-[#A8BED2] underline">ErpNet.FP</a> trebuie instalat și pornit pe calculatorul de la casă, conectat la aparatul fiscal (Datecs, Daisy, Tremol, Eltrade). Cât timp e dezactivat, POS-ul salvează doar bon intern, fără efect fiscal.
      </p>
    </div>
  );
}
