...
const btnPrimary =
  'inline-flex items-center justify-center h-11 px-5 rounded-xl bg-[#FF5C00] hover:bg-[#E04E00] disabled:opacity-50 disabled:cursor-not-allowed text-white text-[15px] font-semibold transition-colors';
const btnGhost =
  'inline-flex items-center justify-center h-11 px-4 rounded-xl bg-white border border-[#E0E0DA] hover:border-[#0A0A0A] disabled:opacity-50 text-[15px] font-semibold transition-colors';
const inputCls =
  'w-full h-11 px-4 rounded-xl border border-[#E8E8E4] bg-white text-[15px] text-[#0A0A0A] focus:outline-none focus:border-[#0A0A0A]';
...
export default function OpenBankingConnect({ configured, localAccounts = [] }: Props) {
    ...
    return (
      <div className={`${card} p-6`}>
        <div className="flex items-start gap-3">
          <span className="mt-1 w-2 h-2 rounded-full bg-[#B45309] shrink-0" />
          <div>
            <h3 className="text-[16px] font-semibold text-[#0A0A0A]">Open banking neconfigurat</h3>
            <p className="text-[14px] text-[#6B6B68] mt-1.5 leading-relaxed">
            ...
            <ul className="mt-3 space-y-1.5 text-[13px] font-mono text-[#0A0A0A]">
              <li className="px-3 py-2 rounded-lg bg-[#FAFAF8] border border-[#E8E8E4]">GOCARDLESS_SECRET_ID</li>
              <li className="px-3 py-2 rounded-lg bg-[#FAFAF8] border border-[#E8E8E4]">GOCARDLESS_SECRET_KEY</li>
            </ul>
            <p className="text-[13px] text-[#6B6B68] mt-3">
  ...
  return (
    <div className="space-y-5">
      ...
      {notice && (
        <div className="px-4 py-3 rounded-xl bg-[#ECFDF3] border border-[#15803D]/30 text-[14px] text-[#15803D]">
          {notice}
        </div>
      )}
      ...
      <div className={`${card} p-6 space-y-4`}>
        <div>
          <h3 className="text-[16px] font-semibold text-[#0A0A0A]">Conectează o bancă</h3>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label className="block text-[14px] font-medium text-[#0A0A0A] mb-1.5">Bancă</label>
            <select
          ...
          {localAccounts.length > 0 && (
            <div>
              <label className="block text-[14px] font-medium text-[#0A0A0A] mb-1.5">
                Cont local (opțional)
              </label>
              <select
                className={`${inputCls} appearance-none`}
      ...
      <div className={`${card} p-6 space-y-4`}>
        <div>
          <h3 className="text-[16px] font-semibold text-[#0A0A0A]">Sincronizează tranzacțiile</h3>
          <p className="text-[14px] text-[#6B6B68] mt-1">
            {requisitionId
