    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <Input className="pl-9 rounded-full bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={q} onChange={(e) => setQ(e.target.value)} placeholder="Caută după nume sau CUI..." />
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                ...
                <div className="flex gap-1">
                  <Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.cui} onChange={(e) => setEditing({ ...editing, cui: e.target.value })} placeholder="RO12345678" />
              ...
              <div><Label className="mb-1 block text-xs text-[#A8BED2]">Nume *</Label><Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.name} onChange={(e) => setEditing({ ...editing, name: e.target.value })} /></div>
              <div><Label className="mb-1 block text-xs text-[#A8BED2]">Reg. comerțului</Label><Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.regCom} onChange={(e) => setEditing({ ...editing, regCom: e.target.value })} placeholder="J40/..." /></div>
              <div><Label className="mb-1 block text-xs text-[#A8BED2]">Țara</Label><Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.country} onChange={(e) => setEditing({ ...editing, country: e.target.value })} /></div>
              <div><Label className="mb-1 block text-xs text-[#A8BED2]">Localitate</Label><Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.city} onChange={(e) => setEditing({ ...editing, city: e.target.value })} /></div>
              <div className="md:col-span-2"><Label className="mb-1 block text-xs text-[#A8BED2]">Adresă</Label><Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.address} onChange={(e) => setEditing({ ...editing, address: e.target.value })} /></div>
              <div><Label className="mb-1 block text-xs text-[#A8BED2]">IBAN</Label><Input autoComplete="off" className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.iban} onChange={(e) => setEditing({ ...editing, iban: e.target.value })} /></div>
              <div><Label className="mb-1 block text-xs text-[#A8BED2]">Email</Label><Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.email} onChange={(e) => setEditing({ ...editing, email: e.target.value })} /></div>
              <div><Label className="mb-1 block text-xs text-[#A8BED2]">Telefon</Label><Input className="bg-white/5 border border-white/[0.12] text-white placeholder:text-[#8FA6BC] focus:ring-2 focus:ring-[#E1FB15]/40 [color-scheme:dark]" value={editing.phone} onChange={(e) => setEditing({ ...editing, phone: e.target.value })} /></div>
            </div>
