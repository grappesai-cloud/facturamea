  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        ...
        <button type="button" onClick={clear} className="mt-1.5 text-[12px] text-[#6B6B68] hover:text-[#FF5C00] transition-colors">
          ↻ Şterge
        </button>
      </div>
      ...
      <button
        ...
        className="px-5 py-2.5 bg-[#FF5C00] hover:bg-[#E04E00] disabled:bg-[#FF5C00]/40 disabled:cursor-not-allowed text-white font-semibold rounded-xl text-[13px] transition-colors"
      >
